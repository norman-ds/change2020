...
Abbildung \@ref(fig:fig-1) macht eine ähnliche Bandbreite (Verlaufsdaten der letzten 10 Jahre) von rund 50 Fällen für die beiden Altersgruppen *0-64* und *65-79* deutlich, wobei die Bandbreite für die Altergruppe *80+* sicher 200 Fälle beträgt und ein Durchhängen zeigt. Ein deutliches Zeichen von saisonalen Abhängigkeit.
...
Eine Gegenüberstellung der Kantone Ticino, Valais und Grischun, wobei in der Ostschweiz weniger bevölkerungsdichte Städte vertreten sind.
...
Regional mag es in einzelnen Altersgruppen zu Übersterblichkeiten gekommen sein, jedoch die Mehrheit der Regionen zeigen keine aussergewöhnliche Todesfallzahlen. **Wir dürfen also mit gutem Mutes zuversichtlich und optimistisch Vorwärtsblicken.**

Anders sieht es teilweise in den europäischen Ländern aus.
